  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-black-500'>Your own <span className='text-primary'>blogging</span><br /> platform.</h1>

        <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-black-500'>Welcome to our blog platform — share your thoughts, explore articles, and connect through stories!</p>
