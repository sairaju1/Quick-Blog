        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <input
              ...
              value={name}
              className="w-full p-2 border border-gray-300 rounded outline-none hover:border-black"
              type="text"
              placeholder="Name"
              required
            />
            <textarea
              ...
              value={content}
              placeholder="Comment"
              className="w-full p-2 border border-gray-300 rounded outline-none h-48 hover:border-black"
              required
            ></textarea>
